class User < ActiveRecord::Base
  ...
  def vimeo_upload
    @vimeo_upload ||= Vimeo::Upload::Base.new(vimeo_api_key, vimeo_api_secret, :token => token , :secret => secret )
    @vimeo_upload    
  end
  def vimeo_simple
    @vimeo_simple ||= Vimeo::Simple::Base.new(vimeo_api_key, vimeo_api_secret)
  end

  def vimeo_upload
    @vimeo_upload ||= Vimeo::Advanced::Base.new(vimeo_api_key, vimeo_api_secret, :token => token || vimeo_token, :secret => secret || vimeo_secret)
  end
